        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
          <div className="lg:col-span-7 space-y-3">
            <div className="flex items-center justify-between">
              <div className="inline-flex items-center gap-2 bg-cyber-violet/15 border border-cyber-violet/40 text-cyber-violet font-mono text-[11px] px-3 py-1 rounded-full font-bold uppercase tracking-wider shadow-[0_0_10px_rgba(139,92,246,0.2)]">
              ...
              <button
                onClick={handlePrint}
                className="no-print inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-mono font-bold bg-cyber-navy/80 border border-cyber-cyan/30 text-cyber-textMuted hover:text-cyber-cyan hover:border-cyber-cyan/60 transition-all cursor-pointer shadow-sm"
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <span className="inline-block mt-1 text-[10px] font-mono font-bold text-cyber-cyan bg-cyber-cyan/10 px-2 py-0.5 rounded border border-cyber-cyan/30">
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2">
              ...
              <div className="inline-flex items-center gap-2 city-glass border border-cyber-magenta/30 px-3.5 py-1.5 rounded-xl shadow-sm">
                <Flame className="w-4 h-4 text-cyber-magenta fill-cyber-magenta/30" />
                <span className="font-orbitron font-bold text-xs text-cyber-magenta">
          ...
          {/* 3D Holo Preview */}
          <div className="lg:col-span-5 city-glass border border-cyber-cyan/25 rounded-2xl p-2 shadow-inner flex items-center justify-center">
